      ...
      <div class="space-y-12">
        ...
        <div id="exps">
          ...
          <div class="py-6">
            ...
            <p>Ho realizzato una serie di tour virtuali (scansioni 3D e foto sferiche a 360º) delle location matrimoniali con Matterport Pro2 per <a class="text-gray-400 hover:text-black hover:ease-in-out duration-1000" href="https://www.matrimonio.com">matrimonio.com</a></p>
          </div>
          
          <div class="py-6">
            <h3 className="font-poppins text-xl text-gray-500 py-3">Carnet Erotico - Francesca Zaccaria (luglio ‘21)</h3>
          <p>Ho prodotto del materiale fotografico ed audiovisivo per la Danzatrice Francesca Zaccaria (ALDES | SPAM!). <a class="text-gray-400 hover:text-black hover:ease-in-out duration-1000" href="https://www.aldesweb.org/produzioni/carnet-erotico/">Link al progetto</a></p>
          </div>
          ...
          <div class="py-6">
            ...
            <a class="text-gray-400 hover:text-black hover:ease-in-out duration-1000" href="https://www.accademiacarrara.it/img/mcybei/index.html">Link al sito della mostra</a>
          </div>
          ...
          <div class="py-6">
            <h3 className="font-poppins text-xl text-gray-500 py-3">Foto Bouquet - <a class="text-gray-400 hover:text-black hover:ease-in-out duration-1000" href="https://www.flickr.com/photos/193622395@N05/sets/72157719705710180/with/51632770803/">Fotografia matrimoniale</a> (da settembre '20 a settembre '21)</h3>
            <p>Fotobouquet è uno studio fotografico specializzato nella realizzazione di servizi foto e video per matrimoni in stile reportage. Produzione di materiale fotografico e audiovisivo.
              Studio Fotografico Foto Bouquet (Via Montebello, 7 - 40124 Bologna) - <a class="text-gray-400 hover:text-black hover:ease-in-out duration-1000" href="https://www.foto-bouquet.com/">foto-bouquet.com</a></p>
          </div>
          ...
          <div class="py-6">
            ...
            <p>VirtuItaly è una startup company, nata come spinoff di Centrica con lo scopo di valorizzare il patrimonio culturale e creativo italiano e creare mostre virtuali interattive e immersive: eventi culturali di grande impatto emotivo e valore educativo e di intrattenimento. Per Virtuitaly ho realizzato uno spot ed altri audiovisivi.
              Virtuitaly S.r.l. (Piazza della Madonna della Neve, 5 – 50122 Firenze) – <a class="text-gray-400 hover:text-black hover:ease-in-out duration-1000" href="https://www.virtuitaly.com/">virtuitaly.com</a> </p>
          </div>
          ...
          <div class="py-6">
            ...
            <p>Centrica S.r.l. è specializzata nella progettazione, nello sviluppo e nella commercializzazione di soluzioni digitali nel campo di: beni culturali, turismo e forme di espressione della creatività. Per Centrica ho prodotto diversi audiovisivi e montaggi fotografici. Attualmente in rapporto per prestazioni occasionali.
              Centrica S.r.l. (Piazza della Madonna della Neve, 5 – 50122 Firenze) –  <a class="text-gray-400 hover:text-black hover:ease-in-out duration-1000" href="https://www.centrica.it/">centrica.it</a> </p>
          </div>
          ...
          <div class="py-6">
            ...
            <p>radioeco.it è la radio degli studenti dell’Università di Pisa. Per Radioeco ho realizzato diversi reportage fotografici dei concerti, spettacoli ed eventi di varia natura, videointerviste e materiale promozionale multimediale; ho svolto anche attività di regia e di supporto tecnico ai programmi radiofonici.
              Radioeco Studio (Via Curtatone e Montanara, 4 – 56126 Pisa) – <a class="text-gray-400 hover:text-black hover:ease-in-out duration-1000" href="http://www.radio-eco.it">radio-eco.it</a></p>
          </div>
        ...
        <div id="exps">
          ...
          <div class="py-6">
            ...
            <p>Accademia di Belle Arti di Carrara (Via Roma, 1 - 54033 Carrara) - <a class="text-gray-400 hover:text-black hover:ease-in-out duration-1000" href="https://www.accademiacarrara.it">accademiacarrara.it</a>.</p>
          </div>
          
          <div class="py-6">
            <h3 className="font-poppins text-xl text-gray-500 py-3">Progetto Museolab (da novembre ‘18 a giugno ‘19)</h3>
          <p>“Tecnico della realizzazione di progetti fotografici, audiovisuali, grafico editoriali e creazione di racconti per immagini”. TD Group Italia (Via Fiume Bianco, 56 - 00144 Roma) - <a class="text-gray-400 hover:text-black hover:ease-in-out duration-1000" href="https://www.tdgroupitalia.it/">tdgroupitalia.it</a></p>
          </div>
